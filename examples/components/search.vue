<template>
  ...
  >
    <template slot-scope="props">
      ...
      <p class="algolia-search-content" v-if="props.item.content" v-html="props.item.content"></p>
      <a class="algolia-search-link" v-if="props.item.img" target="_blank" href="https://www.algolia.com/docsearch">
        <img class="algolia-search-logo" src="../assets/images/search-by-algolia.svg" alt="algolia-logo" />
      </a>
      <p class="algolia-search-empty" v-if="props.item.isEmpty">{{ emptyText }}</p>
    </template>
  </y-autocomplete>
</template>
...
.algolia-search {
  ...
  &.is-empty {
    .y-autocomplete-suggestion__list {
      padding-bottom: 0;
    }
  }
