<template>
  ...
  >
    ...
    <span
      ...
      :class="['y-switch__label', 'y-switch__laby--left', !checked ? 'is-active' : '']"
    >
      <i :class="[inactiveIconClass]" v-if="inactiveIconClass" />
      <span v-if="!inactiveIconClass && inactiveText" :aria-hidden="checked">{{ inactiveText }}</span>
    </span>
    <span class="y-switch__core" ref="core" :style="{ width: coreWidth + 'px' }" />
    <span
      :class="['y-switch__label', 'y-switch__laby--right', checked ? 'is-active' : '']"
