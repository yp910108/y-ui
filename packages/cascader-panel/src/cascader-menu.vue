...
export default {
  ...
  methods: {
    ...
    renderEmptyText() {
      return <div class="y-cascader-menu__empty-text">{this.t('y.cascader.noData')}</div>
    },
    renderNodeList() {
      const { menuId } = this
      ...
      return [...nodes, isHoverMenu ? <svg ref="hoverZone" class="y-cascader-menu__hover-zone" /> : null]
    }
  },
  computed: {
    isEmpty() {
