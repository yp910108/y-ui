<template>
  <div class="y-time-spinner" :class="{ 'has-seconds': showSeconds }">
    ...
    <template v-if="arrowControl">
      <div class="y-time-spinner__wrapper is-arrow" @mouseenter="emitSelectRange('hours')">
        <i v-repeat-click="decrease" class="y-time-spinner__arrow y-icon-arrow-up" />
        <i v-repeat-click="increase" class="y-time-spinner__arrow y-icon-arrow-down" />
        <ul ref="hours" class="y-time-spinner__list">
          <li
      ...
      <div class="y-time-spinner__wrapper is-arrow" @mouseenter="emitSelectRange('minutes')">
        <i v-repeat-click="decrease" class="y-time-spinner__arrow y-icon-arrow-up" />
        <i v-repeat-click="increase" class="y-time-spinner__arrow y-icon-arrow-down" />
        <ul ref="minutes" class="y-time-spinner__list">
          <li
      ...
      <div v-if="showSeconds" class="y-time-spinner__wrapper is-arrow" @mouseenter="emitSelectRange('seconds')">
        <i v-repeat-click="decrease" class="y-time-spinner__arrow y-icon-arrow-up" />
        <i v-repeat-click="increase" class="y-time-spinner__arrow y-icon-arrow-down" />
        <ul ref="seconds" class="y-time-spinner__list">
          <li
...
<script>
import { getRangeHours, getRangeMinutes, modifyTime } from 'main/utils/date-util'
import repeatClick from 'main/directives/repeat-click'
