<template>
  <table class="y-month-table" @click="handleMonthTableClick" @mousemove="handleMouseMove">
    <tbody>
      <tr v-for="(row, key) in rows" :key="key">
        <td :class="getCellStyle(cell)" v-for="(cell, key) in row" :key="key">
          <div>
            <a class="cell">{{ t('y.datepicker.months.' + months[cell.text]) }}</a>
          </div>
        </td>
      </tr>
    </tbody>
...
import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'main/utils/util'
import { hasClass } from 'main/utils/dom'
import { isDate, range, getDayCountOfMonth, nextDate } from 'main/utils/date-util'
