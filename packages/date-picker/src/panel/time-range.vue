<template>
  <transition name="y-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div v-show="visible" class="y-time-range-picker y-picker-panel y-popper" :class="popperClass">
      <div class="y-time-range-picker__content">
        <div class="y-time-range-picker__cell">
          <div class="y-time-range-picker__header">{{ t('y.datepicker.startTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="y-time-range-picker__body y-time-panel__content"
          >
            <time-spinner
              ref="minSpinner"
        ...
        <div class="y-time-range-picker__cell">
          <div class="y-time-range-picker__header">{{ t('y.datepicker.endTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="y-time-range-picker__body y-time-panel__content"
          >
      ...
      <div class="y-time-panel__footer">
        <button type="button" class="y-time-panel__btn cancel" @click="handleCancel()">
          {{ t('y.datepicker.cancel') }}
        </button>
        <button type="button" class="y-time-panel__btn confirm" :disabled="btnDisabled" @click="handleConfirm()">
...
<script>
import { parseDate, limitTimeRange, modifyDate, clearMilliseconds, timeWithinRange } from 'main/utils/date-util'
